        ...
        <>
            ...
            <label>
                Подтверждение пароля:
                    <input type="password" value={values.confirm_password} onChange={inputHandler} id="confirm_password" className="account__input" />
            </label>
            <label>
                Имя:
                    <input type="text" value={values.name} onChange={inputHandler} id="name" className="account__input" />
            </label>
            <Button Class={["submit"]} cb={() => sendFormHandler("/signup")}>Регистрация</Button>
        </>
    )
}